...
List<Flight> flightListFromJson(String str) =>
    List<Flight>.from(json.decode(str).map((x) => Flight.fromJson(x)));

String flightListToJson(List<Flight> data) =>
...
class Flight {
  ...
  String getBoardingTime() {
    // Subtract 1 hour
    DateTime resultTime = depDate!.subtract(const Duration(minutes: 45));
  ...
  factory Flight.fromJson(Map<String, dynamic> json) => Flight(
        ...
        origin: json["origin"],
        depDate:
            json["dep_date"] == null ? null : DateTime.parse(json["dep_date"]),
        destination: json["destination"],
        arrTime:
            json["arr_time"] == null ? null : DateTime.parse(json["arr_time"]),
